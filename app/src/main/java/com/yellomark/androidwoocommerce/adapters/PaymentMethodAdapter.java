...
public class PaymentMethodAdapter extends BaseAdapter {
    ...
    public PaymentMethodAdapter(Context context, List<GetAllPaymentMethod> paymentMethods) {
    ...
    @Override
    public GetAllPaymentMethod getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        GetAllPaymentMethod paymentMethod = paymentMethods.get(position);
        ...
        holder.payment_method_name.setText(paymentMethod.getTitle());
